...
const Header = () => {
    ...
    return (
        <Navbar className='border-b-2'>
            ...
            <Button className="w-10 h-10 lg:hidden border border-gray-500 text-gray-500 !bg-transparent rounded-full flex items-center justify-center hover:border-gray-600 transition-all ">
